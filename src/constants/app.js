...
export const STREAMING_SERVICES = {
  hulu: require('app/assets/img/streaming-services/hulu.png'),
  crunchyroll: require('app/assets/img/streaming-services/crunchyroll.png'),
  netflix: require('app/assets/img/streaming-services/netflix.png'),
  amazon: require('app/assets/img/streaming-services/amazon.png'),
  funimation: require('app/assets/img/streaming-services/funimation.png'),
  hidive: require('app/assets/img/streaming-services/hidive.png'),
  viewster: require('app/assets/img/streaming-services/viewster.png'),
  tubitv: require('app/assets/img/streaming-services/tubitv.png'),
  youtube: require('app/assets/img/streaming-services/youtube.png'),
};
