...
import { AlgoResultsList, TopsList } from './Lists';
...
const Hits = connectInfiniteHits(AlgoResultsList);

class AlgoSearchScreen extends Component {
...
export default connect(mapper, {})(AlgoSearchScreen);
