        ...
        <Content>
          <View style={{ flex: 1, marginTop: 77 }}>
            ...
            <View style={{ backgroundColor: 'white', paddingHorizontal: 12, paddingVertical: 8 }}>
              <Text style={{ fontSize: 10, color: 'grey', fontFamily: 'OpenSans' }}>Username</Text>
              <TextInput
            ...
            <ItemSeparator />
            <View style={{ backgroundColor: 'white', paddingHorizontal: 12, paddingVertical: 8 }}>
              <Text style={{ fontSize: 10, color: 'grey', fontFamily: 'OpenSans' }}>Email Address</Text>
              <TextInput
                style={{ marginTop: 4, height: 30, fontFamily: 'OpenSans', fontSize: 14 }}
                value={'josh@kitsu.io'}
                autoCapitalize={'none'}
            ...
            <ItemSeparator />
            <View style={{ backgroundColor: 'white', paddingHorizontal: 12, paddingVertical: 8 }}>
              <Text style={{ fontSize: 10, color: 'grey', fontFamily: 'OpenSans' }}>Password</Text>
              <TextInput
                style={{ marginTop: 4, height: 30, fontFamily: 'OpenSans', fontSize: 14 }}
                value={'josh@kitsu.io'}
                secureTextEntry
