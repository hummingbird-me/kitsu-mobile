...
export const fetchMediaCastings =
  (mediaId, limit = 20, pageIndex = 0) =>
  async (dispatch, getState) => {
    ...
    try {
      ...
      data = [...data, ...castings];
      dispatch({
        type: types.FETCH_MEDIA_CASTINGS_SUCCESS,
        payload: { castings: data, mediaId },
      });
    } catch (e) {
      // console.log(e);
      dispatch({
...
export const fetchMediaReactions =
  (mediaId, mediaType, limit = 20, pageIndex = 0) =>
  async (dispatch, getState) => {
