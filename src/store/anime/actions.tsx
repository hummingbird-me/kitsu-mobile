...
export const search =
  ...
  async (dispatch, getState) => {
    ...
    dispatch({
      type: pageIndex > 0 ? types.SEARCH_MORE : types.SEARCH,
      field: 'results',
    });
    try {
      let query = {
  ...
  async (dispatch) => {
    ...
    try {
      ...
      dispatch({
        ...
        payload: `${e[0].title}: ${e[0].detail}`,
      });
    }
  };

export const getCategories =
  (id = '_none', parent = 'level0') =>
  async (dispatch, getState) => {
